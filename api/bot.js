  ...
  try {
    ...
    if (update.callback_query) {
      ...
      if (data === 'help') {
        ...
        await bot.sendMessage(uid, `❓ <b>PANDUAN LENGKAP WALZY STORE</b>\n◈━━━━━━━━━━━━━━━━━━━━━━◈\n\n<blockquote>1. <b>Fix Merah:</b> Pilih menu utama lalu masukkan nomor HP target.\n2. <b>Order VIP:</b> Buka Mini Web -> Pindah ke tab Order VIP.\n3. <b>Redeem Voucher:</b> Masukkan kode promo di Mini Web.\n4. <b>Daily Spin & Points:</b> Putar roda keberuntungan dan check-in setiap hari untuk poin gratis.</blockquote>`, {
          parse_mode: 'HTML',
